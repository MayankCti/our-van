...
export default function Header() {
    ...
    const displayName = user?.company_name || user?.full_name || user?.name || 'Supplier';
    const displayEmail = user?.email || '';
    const profileImage = user?.profile_image_url || user?.profile_image || user?.company_logo || '/image.png';
    ...
    return (
        <>
                ...
                <div className="d-flex align-items-center gap-3">
                    <div className="ct_right_dropdown dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <a className="dropdown-item ct_red_text" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#ct_logout_modal_post">
            ...
            {/* Log out Modal */}
            <div className="modal fade" id="ct_logout_modal_post" tabIndex="-1" aria-labelledby="ct_delete_postLabel" aria-hidden="true">
                    ...
                    <div className="modal-content border-0 ct_border_radius_20">
                        ...
                        <div className="modal-body" style={{ paddingInline: "40px" }}>
                            <div className="ct_delete_post_modal">
                                <figure>
                                    <i className="fa-solid fa-arrow-right-from-bracket d-block text-danger text-center mx-auto mb-4 fs-3"></i>
