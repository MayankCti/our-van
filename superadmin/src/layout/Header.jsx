        ...
        <header>
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="ct_border_right_1">
                    <Link to={pageRoutes?.notifications} class="ct_notification_icon">
                ...
                <div class="ct_right_dropdown dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li>
                            <Link class="dropdown-item" to={pageRoutes?.editProfile}>
                        ...
                        <li>
                            <Link class="dropdown-item" to={pageRoutes?.changePassword}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="ct_delete_post_modal">
                            ...
                            <div class="d-flex justify-content-center border-0 gap-3 ct_modal_footer ct_flex_col_575 mb-5 mt-4">
                                ...
                                <button
                                    ...
                                    class="ct_form_next action-button w-100 text-center" data-bs-dismiss="modal">Yes, Log Me Out
                                </button>
                            </div>
                        </div>
                    </div>
