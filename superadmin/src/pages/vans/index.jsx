    ...
    <Layout>
         <div class="ct_right_panel">
            ...
            <div class="ct_inner_header_bg mt-4 ct_px_30 d-flex align-items-center justify-content-between gap-3 ct_flex_col_575">
               <div>
                  <h4 class="fs-4 ct_head_clr ct_fw_600 mb-0 ct_black_text">Vans</h4>
                  <p class="mb-0 ct_para_clr">Manage all customer vans, vehicle information, warranties, and maintenance records.</p>
               </div>
            </div>
                     ...
                     <table class="table  align-middle mb-0">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>13 Jul 2026</td>
                              <td>
                                 <a href="van-details.html" class="ct_action_link">View Details</a>
                              </td>
                           </tr>
                           <tr>
                              <td>2</td>
