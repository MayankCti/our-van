...
const OwnerDetail = () => {
  ...
  // Fetch owner details on mount and when page / limit changes
  useEffect(() => {
    if (ownerId) {
      dispatch(
        getOwnerDetails({
  ...
  }, [dispatch, ownerId, currentPage, listPerPages]);
  ...
  const isBlocked =
    ownerDetails?.status?.toUpperCase() === "BLOCKED" ||
    ownerDetails?.status?.toUpperCase() === "INACTIVE";
  ...
  const ownerName =
    ...
    (ownerDetails?.email ? ownerDetails.email.split("@")[0] : "Owner");
    ...
    <Layout>
      <div className="ct_right_panel">
        ...
        <div className="ct_inner_header_bg mt-4 ct_px_30 d-flex align-items-center justify-content-start gap-2">
          <Link to={pageRoutes.owners} aria-label="Back to Owners">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <div>
            <h4 className="fs-4 ct_head_clr ct_fw_600 mb-0 ct_black_text">Owner Details</h4>
            <p className="mb-0 ct_para_clr">View owner information and assigned vehicles.</p>
          </div>
        </div>
        ...
        <div className="ct_px_30 mt-4 pb-4">
          <div className="container-fluid">
            ...
            <div className="ct_profile_card mb-4" style={{ paddingBlock: "28px" }}>
              {isOwnerDetailsLoading && !ownerDetails ? (
                ...
                <div className="d-flex justify-content-between align-items-center mb-0 flex-wrap gap-4">
                  ...
                  <div>
                    <button
                      ...
                      data-bs-target="#blockOwnerModal"
            ...
            <div className="d-flex justify-content-between align-items-end mb-3">
              <div>
                ...
                <p className="ct_para_clr ct_fs_12 mb-0">
                  View all vans registered under this owner.
                </p>
              </div>
            </div>
                  ...
                  <tbody>
                    {isOwnerDetailsLoading ? (
                      ...
                      assignedVans.map((van, index) => {
                        ...
                        const vanName = van.vanName || van.name || van.van_name || "N/A";
                        const registrationNumber =
                          van.registrationNumber || van.registration_number || "N/A";
                        const dealerName =
                          van.dealerName || van.dealer || van.dealer_name || "N/A";
            ...
            {/* Pagination footer */}
            {!isOwnerDetailsLoading && assignedVans?.length > 0 && (
      ...
      {/* Block / Unblock Owner Modal */}
      <div className="modal fade" id="blockOwnerModal" tabIndex="-1">
          ...
          <div className="modal-content ct_modal">
            <div className="modal-body p-4 position-relative">
              ...
              <h3 className="ct_head_clr ct_fw_600 mb-3">
                {isBlocked ? "Unblock Owner?" : "Block Owner?"}
              </h3>
