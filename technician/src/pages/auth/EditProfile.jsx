...
const EditProfile = () => {
  ...
  const profileImageSrc = imagePreview || user?.profile_image_url || user?.profile_image || '/image.png';

  return (
    <Layout>
      <SubHeader
        title="Edit Profile"
        subtitle="Update your technician account information"
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-flex align-items-center gap-3 flex-wrap mb-5">
                  ...
                  <div>
                    <h4 className="mb-1 ct_head_clr fs-5 ct_fw_600">{user?.full_name || user?.name || 'Technician'}</h4>
                ...
                <div className="row g-4">
                  ...
                  <div className="col-lg-6">
                    <label className="form-label ct_label">Job Role</label>
                    <input
                      type="text"
                      name="job_role"
                      id="job_role"
                  ...
                  <div className="col-lg-12">
                    <label className="form-label ct_label">Address</label>
                    <input
                      type="text"
                      name="address"
                      id="address"
