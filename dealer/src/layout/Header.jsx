        ...
        <>
            <header>
                <div className="d-flex align-items-center gap-2">
                    <i className="fa-solid fa-bars me-3 ct_fs_18 ct_menu_bar"></i>
                </div>
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="ct_right_dropdown dropdown">
                        <button id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                            <div className="d-flex align-items-center gap-2">
                                <img src="assets/img/profile_img.png" alt="" className="ct_img_25" />
                                <div className="text-start">
                                    <small className="ct_text_939393">James Wilson</small>
                                </div>
                            </div>
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                                <div className="ct_profile_dtl">
                                    <h6>James Wilson</h6>
                                    <p className="mb-0">jameswilson@email.com</p>
                                </div>
                            </li>
                            <li>
                                <Link className="dropdown-item" to={pageRoutes?.editProfile}>
