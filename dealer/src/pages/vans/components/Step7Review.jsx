...
const Step7Review = ({ onPrev, modalTargetId = "#successModal" }) => {
    return (
        <fieldset>
            <div className="ct_profile_card text-start">
                ...
                <section className="ct_profile_card">
                    ...
                    <div className="row">
                        <div className="col-xl-2">
                            <img src="assets/img/vehicle_1.jpg" className="img-fluid ct_vehicle_img mb-3" alt="" />
                        </div>

                        <div className="col-xl-10">
                            <div className="row gy-4">
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">Model</h5>
                                    <h6 className="mb-0 ct_head_clr">Jayco Journey</h6>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">VIN</h5>
                                    <h6 className="mb-0 ct_head_clr">6T1BE32K54X123456</h6>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">Registration</h5>
                                    <h6 className="mb-0 ct_head_clr">NSW 482 XYZ</h6>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">Engine</h5>
                                    <h6 className="mb-0 ct_head_clr">2.3L Turbo Diesel</h6>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">Year</h5>
                                    <h6 className="mb-0 ct_head_clr">2024</h6>
                                </div>
                                <div className="col-md-4 col-sm-6">
                                    <h5 className="ct_fs_14 ct_fw_600 ct_para_clr mb-1 text-uppercase">Chassis Number</h5>
                                    <h6 className="mb-0 ct_head_clr">98HCBH219SXB44</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="ct_profile_card ct_mt_30">
                    ...
                    <div className="d-flex gap-5 flex-wrap">
                        <div>
                            <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">FULL NAME</h6>
                            <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">James Wilson</h5>
                        </div>
                        <div>
                            <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">EMAIL ADDRESS</h6>
                            <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">james.wilson@email.com.au</h5>
                        </div>
                        <div>
                            <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">PHONE</h6>
                            <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">+61 412 345 678</h5>
                        </div>
                    </div>
                </section>
                ...
                <section className="ct_profile_card ct_mt_30">
                    <div className="d-flex align-items-center gap-2 mb-4">
                        ...
                        <h5 className="ct_green_text ct_fs_16 ct_fw_600 mb-0">Installed Components</h5>
                    </div>

                    <div className="d-flex gap-2 flex-wrap overflow-auto ct_custom_scroll" style={{ maxHeight: "250px" }}>
                        <div className="installed_comp_badge">Battery</div>
                        <div className="installed_comp_badge">Solar Panels</div>
                        <div className="installed_comp_badge">Fridge</div>
                        <div className="installed_comp_badge">Water Pump</div>
                        <div className="installed_comp_badge">Air Conditioner</div>
                        <div className="installed_comp_badge">Gas System</div>
                        <div className="installed_comp_badge">Brakes</div>
                        <div className="installed_comp_badge">Suspension</div>
                        <div className="installed_comp_badge">Tyres</div>
                        <div className="installed_comp_badge">Awning</div>
                        <div className="installed_comp_badge">Electrical System</div>
                    </div>
                </section>
                        ...
                        <div className="col-xl-9">
                            <div className="row">
                                <div className="col-md-3 col-sm-6 mb-md-0 mb-3">
                                    <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">Provider</h6>
                                    <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">Summer Breeze</h5>
                                </div>
                                <div className="col-md-3 col-sm-6 mb-md-0 mb-3">
                                    <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">Coverage TYPE</h6>
                                    <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">Structural Body</h5>
                                </div>
                                <div className="col-md-3 col-sm-6 mb-md-0 mb-3">
                                    <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">START DATE</h6>
                                    <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">13-05-2026</h5>
                                </div>
                                <div className="col-md-3 col-sm-6 mb-md-0 mb-3">
                                    <h6 className="mb-1 ct_fs_14 ct_fw_600 ct_para_clr">EXPIRY DATE</h6>
                                    <h5 className="ct_fs_16 ct_fw_500 mb-0 ct_head_clr">13-05-2030</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="ct_profile_card ct_mt_30">
                    <div className="d-flex align-items-center gap-2 mb-4">
                        ...
                        <h5 className="ct_green_text ct_fs_16 ct_fw_600 mb-0">Documents</h5>
                    </div>

                    <div className="d-flex gap-4 flex-wrap">
                        <div className="ct_doc_custom_box">
                ...
                <section className="ct_profile_card ct_mt_30">
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-sm-6 mb-sm-0 mb-3">
                            <div className="ct_claim_info_box">
                                <h6 className="mb-1 ct_fs_12 ct_fw_600 ct_para_clr">FIRST SERVICE DATE</h6>
                                <h5 className="ct_fs_16 ct_fw_600 mb-0 ct_head_clr">April 12, 2025</h5>
                            </div>
                        </div>
                        <div className="col-xl-4 col-sm-6 mb-sm-0 mb-3">
                            <div className="ct_claim_info_box">
                                <h6 className="mb-1 ct_fs_12 ct_fw_600 ct_para_clr">SERVICE CENTRE</h6>
                                <h5 className="ct_fs_16 ct_fw_600 mb-0 ct_head_clr">Jayco Sydney North</h5>
                            </div>
                        </div>
                    </div>
                    <div className="mt-4">
                        <h6 className="mb-0 ct_fs_12 ct_fw_600 ct_para_clr mb-1">Internal Notes</h6>
                        <h5 className="ct_fs_16 ct_fw_400 mb-0 ct_head_clr">Contact the warranty provider with proof of purchase before submitting a claim.</h5>
                    </div>
                </section>
            </div>
            ...
            <div className="d-flex justify-content-end ct_mt_56 gap-4 ct_flex_col_575">
                ...
                <button
                    ...
                    className="action-button ct_w_100_575 border-0"
                >
                    Create Van Profile
                </button>
            </div>
