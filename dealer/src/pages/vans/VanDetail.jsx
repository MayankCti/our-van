...
const VanDetail = () => {
  ...
  const vanId = searchParams.get('van_id') || searchParams.get('id');
  ...
  const details = vanDetailsData?.data || vanDetailsData || {};
  const vd = details?.van || details?.vehicle_details || details?.vehicle || details || {};
  const van = (details?.van || details?.vehicle_details || details?.vehicle) ? vd : details;
  ...
  const rawDocs = details?.documents || details?.van_documents || details?.vehicle_documents || details?.step_5;
  ...
  return (
    <Layout>
      ...
      <div className="ct_px_30 mt-4 pb-4">
        {isVanDetailsLoading && !vanDetailsData ? (
          <div className="ct_profile_card text-center py-5">
            <div className="spinner-border text-success mb-3" role="status">
              <span className="visually-hidden">Loading van details...</span>
            </div>
          ...
          <>
            ...
            <section className="ct_profile_card">
              ...
              {images.length > 0 && (
                <div className="mt-4 pt-3 border-top">
                  <h6 className="ct_fs_13 ct_fw_600 ct_para_clr mb-2">VEHICLE PHOTOS ({images.length})</h6>
            ...
            <section className="ct_profile_card ct_mt_30">
              <div className="d-flex align-items-center gap-2 mb-4">
                ...
                <h5 className="ct_green_text ct_fs_16 ct_fw_600 mb-0">Owner Details</h5>
              </div>
              ...
              {owner ? (
                ...
                <div className="p-3 bg-light rounded-3 d-flex align-items-center gap-2 text-muted">
                  <i className="fa-solid fa-user-slash fs-5"></i>
                  <span className="ct_fs_14">No owner assigned to this van yet.</span>
                </div>
              )}
            </section>
            ...
            <section className="ct_profile_card ct_mt_30">
              ...
              {components.length === 0 ? (
                <p className="text-muted mb-0 ct_fs_14">No components recorded for this vehicle.</p>
              ) : (
                <>
                  <div className="d-flex gap-2 flex-wrap mb-4">
                    {components.map((comp, idx) => (
                      <div className="installed_comp_badge" key={comp.id || idx}>
                    ...
                    {components.map((comp, idx) => {
                      ...
                      const isImg =
                        ...
                        (/\.(png|jpe?g|webp)$/i.test(fileUrl) ||
                          (compFile?.mime_type && compFile.mime_type.startsWith('image/')));
                              ...
                              <div className="d-flex align-items-center justify-content-between gap-2 mb-2">
                                ...
                                <span className="badge bg-success-subtle text-success px-2 py-1 rounded-pill ct_fs_12 ct_fw_500">
                                  {comp.warranty_period_months
                                    ? `${comp.warranty_period_months} Mo. Warranty`
                                    : 'Active'}
                                </span>
                              </div>
            ...
            <section className="ct_profile_card ct_mt_30">
              ...
              {warranty ? (
                  ...
                  <div className="col-xl-9">
                    ...
                    {(warranty?.claim_instructions || warranty?.notes) && (
                      <div className="mt-3">
                        ...
                        <p className="ct_fs_14 ct_head_clr mb-0">
                          {warranty.claim_instructions || warranty.notes}
                        </p>
                      </div>
                    )}
                    ...
                    return warrantyDocUrl ? (
                      <div className="col-xl-3">
                        ...
                        >
                          ...
                          <span>
                            Warranty Document <i className="fa-solid fa-arrow-up-right-from-square ms-1 ct_fs_11"></i>
                          </span>
                        </div>
                      </div>
                    ) : null;
                ...
                <p className="text-muted mb-0 ct_fs_14">No warranty details recorded.</p>
              )}
            </section>
            ...
            <section className="ct_profile_card ct_mt_30">
              ...
              {maintenance ? (
                    ...
                    <div className="col-xl-3 col-sm-6">
                      <div className="ct_claim_info_box">
                        ...
                        <h5 className="ct_fs_14 ct_fw_600 mb-0 ct_head_clr">
                          Push:{' '}
                          <span className={maintenance?.notify_push ? 'text-success' : 'text-danger'}>
                            {maintenance?.notify_push ? 'Yes' : 'No'}
                          </span>
                          {' | '}
                          Email:{' '}
                          <span className={maintenance?.notify_email ? 'text-success' : 'text-danger'}>
                            {maintenance?.notify_email ? 'Yes' : 'No'}
                          </span>
                        </h5>
                      </div>
                    </div>
                ...
                <p className="text-muted mb-0 ct_fs_14">No maintenance setup recorded.</p>
              )}
            </section>
          </>
        )}
